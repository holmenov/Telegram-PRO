...
Теперь предлагаю пройтись по переключателям, которые находятся в самом вверху настроек. Их всего 10:
...
5. **Вступать в каналы** - Эту настройку необходимо включать для 2,3 и 4 режима работы. Он вступает в каналы, которые указаны в настройке "Список каналов для вступления".
...
10. **Использовать превью в комментариях** - Использование функции "превью" из Telegram. Если не знаете что это такое, то попробуйте отправить ссылку кому-нибудь в ЛС в телеграме и под ссылкой вы увидите превью.
