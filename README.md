...
9. **Использовать Telegram уведомления** - При включении этой функции, бот будет отсылать вам важные уведомления в вашего телеграм бота. Нужен будет токен бота и ваш ID в телеграме.
