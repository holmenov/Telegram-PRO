...
Теперь предлагаю пройтись по переключателям, которые находятся в самом вверху настроек. Их всего 6:
